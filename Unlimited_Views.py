#!/system/bin/python
#TOOL OWNER TAKE DOWN FIGHTERS
#Coded By Solanki_Paresh_Tech
#Date & Time 1/11/2022 [06:09]
#TDF
import urllib2
import urllib
import sys
...
print "B+G+"
print "  _____     __        ___                  "
print " |_   _|_ _| |_____  |   \ _____ __ ___ _  "
print "   | |/ _` | / / -_) | |) / _ \ V  V / ' \ "
print "   |_|\__,_|_\_\___| |___/\___/\_/\_/|_||_|"
print "_"
print "-"
print B+R+""
print "    _______________ _______________  ____ "
print "   / __/  _/ ___/ // /_  __/ __/ _ \/ __/ "
print "  / _/_/ // (_ / _  / / / / _// , _/\ \   "
print " /_/ /___/\___/_//_/ /_/ /___/_/|_/___/   "
print " __ ___ ___ _  _ _____ ___ ___  ___"
print " __ ___ ___ _  _ _____ ___ ___  ___"
time.sleep(2)
print ''
print B+BL+'#-----------------------------------------#'
print B+R+'        TAKE LOVE FROM paresh FAMILY'
print B+BL+'#-----------------------------------------#'
print B+W+' 1.YOU CAN GET UNLIMITED VIEW FROM THIS TOOL'
print B+W+'2.THIS TOOL OWNER :solanki_paresh_tech'
print B+W+'3.CODED BY solanki paresh'
print B+W+'4.WE ARE SYSTEM MAKERS'
print B+W+'5.TAKE LOVE FROM solanki Paresh FAMILY '
print B+BL+'#-----------------------------------------#'
print B+R+'               \!/WARNING\!/'
print B+BL+'#-----------------------------------------#'
